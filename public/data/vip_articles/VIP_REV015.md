# REV015 · Fade đỉnh/đáy tuần chạm lần đầu — bài phân tích chuyên sâu
...
- Kỷ lục **23 lệnh thua liên tiếp** (năm 2017).
- Cú sụt vốn sâu nhất 22 năm: **-62R**, mất 149 tháng mới thấy đáy.

## Chiến lược này kiếm tiền bằng logic gì?

Chạm đỉnh tuần trước lần đầu — bán phản ứng. Nguồn gốc: Session levels. Cài đặt đem kiểm định: `{"period": "W", "mode": "fade", "sl_atr": 2.0, "tp_r": 3.0}`.
...
- **Khoảng 28 lệnh mỗi năm** trên khung H4; bình thường các lệnh cách nhau ~11 ngày, nhưng có lúc 54 ngày liền không có lệnh nào — tháng im lặng là bình thường, không phải chiến lược hỏng.
...
**Chuỗi thua dài nhất: 23 lệnh liên tiếp** (rơi vào năm 2017). Rủi ro 1 triệu mỗi lệnh nghĩa là có giai đoạn mất 23 triệu liền mạch không một lệnh gỡ — hãy tự hỏi thật lòng bạn còn bấm nút nổi ở lệnh thứ 20 không, vì người bỏ cuộc thường bỏ đúng trước khi chuỗi kết thúc.

**Sụt vốn sâu nhất: -62R**, bắt đầu từ 2005-10 và **tới nay vẫn chưa quay lại đỉnh cũ**.

Năm tốt nhất: 2020 (+0.87 R/lệnh). Năm tệ nhất: 2017 (-0.57 R/lệnh). Chiến lược nào cũng có mùa — biết trước mùa xấu trông ra sao là một nửa việc sống sót.

## Điểm thi chính thức

| Giai đoạn | Số lệnh | Lãi TB/lệnh | Tỷ lệ thắng | Năm lãi |
|---|---|---|---|---|
| Ôn bài 2004–2018 | 405 | -0.095 R | 23.7% | 5/15 |
| **Kỳ thi thật 2019–2023** | 129 | **+0.151 R** | 30.2% | 3/5 |
| **Kỳ thi lần 2 02/2024–07/2026** | 70 | **-0.099 R** | 24.3% | 2/3 |


So với vào lệnh ngẫu nhiên trên 16 thị trường trộn: hơn -0.036 R/lệnh. Kỳ vọng thực tế nên giữ quanh mức điểm kỳ thi thật (+0.15 R/lệnh — rủi ro 1 triệu/lệnh thì trung bình lãi 151 nghìn/lệnh, tính trên hàng chục lệnh chứ không phải từng lệnh).

Kỳ thi lần 2 (02/2024→07/2026): **đã suy yếu** — lỗ -0.099 R/lệnh qua 70 lệnh. Kết luận gốc giữ nguyên theo luật đã khai báo, nhưng nếu bạn quan tâm chiến lược này thì đây là tín hiệu phải theo dõi sát.
...
**Cỡ lệnh trước, mộng mơ sau.** Lấy chuỗi thua kỷ lục (23) nhân đôi cho an toàn (~46R) rồi hỏi: mất bao nhiêu % tài khoản thì vẫn ngủ được? Chia ngược lại ra % rủi ro mỗi lệnh. Đó là toán, không phải ý kiến.
