# MTF003 · H4 trend + M15 breakout — giải phẫu vì sao rớt
...
- Chạy máy móc suốt 22 năm (6169 lệnh, đã trừ phí): **cộng dồn -819R**. Rủi ro 1 triệu mỗi lệnh thì kết quả của hơn hai thập kỷ kiên trì là mất ~819 triệu.
- Tỷ lệ thắng thật: **~27%**; chuỗi thua dài nhất **21 lệnh liên tiếp** (2020).
- Đường vốn tạo đỉnh từ 2006-07 và **tới nay chưa quay lại** — ai theo nó từ đó vẫn đang chờ hòa vốn.

## Nó hứa gì — và máy đo được gì

Quy tắc được kiểm: H4 xếp EMA thuận → M15 phá đỉnh cục bộ thì vào. Nguồn gốc: Phổ biến. Cài đặt: `{"sl_atr": 2.0, "tp_r": 3.0, "dummy": 1}`. Máy chạy đúng quy tắc này trên 22 năm, khớp lệnh bi quan (nến chạm cả hai phía tính là thua), trừ phí từng lệnh — và máy không quên những cú vào xấu:

| Giai đoạn | Số lệnh | Lãi TB/lệnh | Tỷ lệ thắng | Năm lãi |
|---|---|---|---|---|
| Ôn bài 2004–2018 | 3942 | -0.105 R | 27.8% | 2/15 |
| **Kỳ thi thật 2019–2023** | 1379 | **-0.222 R** | 25.2% | 0/5 |
| **Kỳ thi lần 2 02/2024–07/2026** | 785 | **-0.081 R** | 27.0% | 1/3 |


## Vì sao nó rớt

**Nó không thắng nổi người vào lệnh ngẫu nhiên.** Giai đoạn ôn bài nó đạt -0.105 R/lệnh, còn "người vào đại" trên thị trường trộn ngẫu nhiên đạt -0.116 — phần chênh không đủ gọi là kỹ năng.
...
**Nó chưa từng thật sự chạy — kể cả ở sân nhà.** Ngay giai đoạn ôn bài 2004–2018, nơi mọi chiến lược được phép "học tủ", nó chỉ đạt -0.105 R/lệnh; sang kỳ thi thật còn -0.222. Không phải "thị trường thay đổi nên nó hết chạy" — nó chưa từng chạy.
...
**Sụt vốn sâu nhất: -903R**, bắt đầu từ 2006-07 và **tới nay vẫn chưa quay lại đỉnh cũ**.

Năm tốt nhất: 2006 (+0.15 R/lệnh). Năm tệ nhất: 2021 (-0.38 R/lệnh). Chiến lược nào cũng có mùa — biết trước mùa xấu trông ra sao là một nửa việc sống sót.

Kỳ thi lần 2 (02/2024→07/2026): tiếp tục lỗ -0.081 R/lệnh qua 785 lệnh — đúng như kết luận CHÁT.
