# BRK011 · Camarilla R4/S4 breakout — bài phân tích chuyên sâu
...
- Kỷ lục **19 lệnh thua liên tiếp** (năm 2022).
- Cú sụt vốn sâu nhất 22 năm: **-64R**, mất 28 tháng mới thấy đáy.

## Chiến lược này kiếm tiền bằng logic gì?

Phá R4/S4 — vào tiếp diễn. Nguồn gốc: Nick Scott. Cài đặt đem kiểm định: `{"mode": "break", "sl_atr": 2.0, "tp_r": 3.0}`.
...
- **Khoảng 102 lệnh mỗi năm** trên khung H1; bình thường các lệnh cách nhau ~3 ngày, nhưng có lúc 18 ngày liền không có lệnh nào — tháng im lặng là bình thường, không phải chiến lược hỏng.
- Lệnh thắng điển hình giữ ~27 giờ, lệnh thua bị đá ra sau ~11 giờ. Giữ lệnh qua đêm/cuối tuần là chuyện thường — không hợp với người không ngủ được khi đang ôm lệnh.
...
**Sụt vốn sâu nhất: -64R**, kéo dài 28 tháng (từ 2021-05 tới đáy 2023-09, hồi phục hẳn 2026-01). Ai dùng nó phải biết trước con số này để định cỡ vốn và chuẩn bị tâm lý — không phải để bất ngờ giữa chừng.

Năm tốt nhất: 2026 (+0.48 R/lệnh). Năm tệ nhất: 2018 (-0.26 R/lệnh). Chiến lược nào cũng có mùa — biết trước mùa xấu trông ra sao là một nửa việc sống sót.

## Điểm thi chính thức

| Giai đoạn | Số lệnh | Lãi TB/lệnh | Tỷ lệ thắng | Năm lãi |
|---|---|---|---|---|
| Ôn bài 2004–2018 | 1457 | +0.070 R | 29.0% | 10/15 |
| **Kỳ thi thật 2019–2023** | 488 | **+0.039 R** | 28.7% | 3/5 |
| **Kỳ thi lần 2 02/2024–07/2026** | 274 | **+0.166 R** | 31.4% | 3/3 |


So với vào lệnh ngẫu nhiên trên 16 thị trường trộn: hơn +0.117 R/lệnh. Kỳ vọng thực tế nên giữ quanh mức điểm kỳ thi thật (+0.04 R/lệnh — rủi ro 1 triệu/lệnh thì trung bình lãi 39 nghìn/lệnh, tính trên hàng chục lệnh chứ không phải từng lệnh).

Kỳ thi lần 2 (02/2024→07/2026, dữ liệu hoàn toàn mới): **vẫn giữ vững** — lãi trung bình +0.166 R/lệnh qua 274 lệnh. Đừng lấy giai đoạn đẹp này làm kỳ vọng dài hạn: con số nên khắc vào đầu vẫn là điểm kỳ thi thật.
...
**Cỡ lệnh trước, mộng mơ sau.** Lấy chuỗi thua kỷ lục (19) nhân đôi cho an toàn (~38R) rồi hỏi: mất bao nhiêu % tài khoản thì vẫn ngủ được? Chia ngược lại ra % rủi ro mỗi lệnh. Đó là toán, không phải ý kiến.
