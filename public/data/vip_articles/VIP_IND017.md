# IND017 · CCI ±100 breakout — bài phân tích chuyên sâu
...
- Kỷ lục **27 lệnh thua liên tiếp** (năm 2018).
- Cú sụt vốn sâu nhất 22 năm: **-179R**, mất 120 tháng mới thấy đáy.

## Chiến lược này kiếm tiền bằng logic gì?

CCI vượt +100 mua momentum, thủng −100 bán. Nguồn gốc: Donald Lambert (1980). Cài đặt đem kiểm định: `{"mode": "break", "n": 20, "th": 100.0, "sl_atr": 2.0, "tp_r": 3.0}`.
...
- **Khoảng 155 lệnh mỗi năm** trên khung H1; bình thường các lệnh cách nhau ~1 ngày, nhưng có lúc 15 ngày liền không có lệnh nào — tháng im lặng là bình thường, không phải chiến lược hỏng.
- Lệnh thắng điển hình giữ ~27 giờ, lệnh thua bị đá ra sau ~10 giờ. Giữ lệnh qua đêm/cuối tuần là chuyện thường — không hợp với người không ngủ được khi đang ôm lệnh.
...
**Chuỗi thua dài nhất: 27 lệnh liên tiếp** (rơi vào năm 2018). Rủi ro 1 triệu mỗi lệnh nghĩa là có giai đoạn mất 27 triệu liền mạch không một lệnh gỡ — hãy tự hỏi thật lòng bạn còn bấm nút nổi ở lệnh thứ 24 không, vì người bỏ cuộc thường bỏ đúng trước khi chuỗi kết thúc.

**Sụt vốn sâu nhất: -179R**, bắt đầu từ 2008-10 và **tới nay vẫn chưa quay lại đỉnh cũ**.

Năm tốt nhất: 2023 (+0.31 R/lệnh). Năm tệ nhất: 2018 (-0.35 R/lệnh). Chiến lược nào cũng có mùa — biết trước mùa xấu trông ra sao là một nửa việc sống sót.

## Điểm thi chính thức

| Giai đoạn | Số lệnh | Lãi TB/lệnh | Tỷ lệ thắng | Năm lãi |
|---|---|---|---|---|
| Ôn bài 2004–2018 | 2292 | -0.056 R | 26.0% | 5/15 |
| **Kỳ thi thật 2019–2023** | 703 | **+0.109 R** | 30.3% | 4/5 |
| **Kỳ thi lần 2 02/2024–07/2026** | 397 | **-0.007 R** | 27.0% | 2/3 |


So với vào lệnh ngẫu nhiên trên 16 thị trường trộn: hơn -0.002 R/lệnh. Kỳ vọng thực tế nên giữ quanh mức điểm kỳ thi thật (+0.11 R/lệnh — rủi ro 1 triệu/lệnh thì trung bình lãi 109 nghìn/lệnh, tính trên hàng chục lệnh chứ không phải từng lệnh).

Kỳ thi lần 2 (02/2024→07/2026): **đã suy yếu** — lỗ -0.007 R/lệnh qua 397 lệnh. Kết luận gốc giữ nguyên theo luật đã khai báo, nhưng nếu bạn quan tâm chiến lược này thì đây là tín hiệu phải theo dõi sát.
...
**Cỡ lệnh trước, mộng mơ sau.** Lấy chuỗi thua kỷ lục (27) nhân đôi cho an toàn (~54R) rồi hỏi: mất bao nhiêu % tài khoản thì vẫn ngủ được? Chia ngược lại ra % rủi ro mỗi lệnh. Đó là toán, không phải ý kiến.
